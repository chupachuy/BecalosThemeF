...
function fncBtnDon(){
	...
	$('.areaInac').show();
	$('.btnDonar').html('Clic aquí para donar');
}
...
// __________________________________________ INFORME
	...
	$('#menu-item-386').on('click', abrirModal);
	...
	// _________________________________________ DESCARGA DE INFORMES

	function fncDesInf(){
		var fecInf = $('#sel_fe_inf').val();
		//alert(fecInf);
		window.open(urlPDFS + "informes/informe_"+fecInf+".pdf","_blank");
	}
