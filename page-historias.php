...
<div class="bar">
		...
		<div class="filter">
			...
			<a href="<?php bloginfo('url'); ?>/programas/" id="ddc" class="action filter__item btn-programas"><i class="icon icon--shoe"></i><span class="action__text">Ver programas</span></a>
		</div>
	...
	<div class="view" style="height: auto !important;">
		<!-- Blueprint header -->
		<!-- Grid -->
		<section style="top: 15em; padding-bottom: 15em;" class="grid grid--loading">
			<!-- Loader -->
			...
			while($custom_query->have_posts()) : $custom_query->the_post(); ?>
				<div id="post-<?php the_ID(); ?>" class="grid__item <?php $category = get_the_category(); echo $category[0]->slug; ?>">
					...
					<div class="meta">
						<a class="btn_his_1" href="<?php bloginfo('url'); ?>/programas/"><?php foreach((get_the_category()) as $category) { echo $category->cat_name . ' '; } ?></a>
